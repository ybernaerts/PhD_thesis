...
3. `sbnn.ipynb` produces figures illustrating results from using sparse bottleneck neural networks or **sBNNs** for the nonlinear prediction of ephys measurements based on gene expression levels. Definitely check out [this](https://github.com/berenslab/sBNN) GitHub repo to see how we got to those results.
